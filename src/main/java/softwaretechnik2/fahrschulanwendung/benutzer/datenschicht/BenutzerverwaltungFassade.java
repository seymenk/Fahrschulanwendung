...
/**
 * Die BenutzerverwaltungFassade Klasse dient als Zwischenschicht zwischen der Anwendungsschicht und der Datenschicht.
 * Sie bietet Methoden zur Interaktion mit dem UserDAO, FahrlehrerDAO und FahrschuelerDAO.
 * Sie wird als Spring Komponente definiert und verwendet die Autowiring Funktion von Spring, um Abhängigkeiten zu injizieren.
 * @author seymen
 */
@Component
public class BenutzerverwaltungFassade {
    ...
    /**
     * Sucht und gibt ein Benutzerkonto zurück, das mit dem angegebenen Benutzernamen und Passwort übereinstimmt.
     * @param username Der Benutzername des Benutzerkontos.
     * @param password Das Passwort des Benutzerkontos.
     * @return Das Benutzerkonto, das mit dem angegebenen Benutzernamen und Passwort übereinstimmt, oder null, wenn kein solches Benutzerkonto gefunden wurde.
     */
     ...
     * @return true, wenn ein Benutzerkonto mit dem angegebenen Benutzernamen existiert, sonst false.
     */
    ...
    /**
     * Sucht und gibt ein Benutzerkonto zurück, das mit dem angegebenen Benutzernamen übereinstimmt.
     * @param username Der Benutzername des Benutzerkontos.
